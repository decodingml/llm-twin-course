...
LOCAL_IMAGE_NAME="linkedin-crawler" # Replace with your local image name
IMAGE_TAG="linkedin-crawler:latest"
...
docker build -t $LOCAL_IMAGE_NAME -f docker/Dockerfile.linkedin .
