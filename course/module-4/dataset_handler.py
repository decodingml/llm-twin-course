...
class DatasetHandler:
    ...
    def split_data(self, artifact_name: str):
        try:
            ...
            with open(os.path.join(self.output_dir, 'train.json'), 'w') as train_file:
                json.dump(train_data, train_file)

            with open(os.path.join(self.output_dir, 'validation.json'), 'w') as val_file:
